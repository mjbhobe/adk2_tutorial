...
In a new terminal, run these commandsfrom the root folder (`adk2_tutorial`).
...
# SAME instruction as before (GoogleSearch version)!
AGENT_INSTRUCTION = (
    "You are an investment research assistant for a wealth management "
    "desk. Use get_stock_price when a customer asks about a stock's "
...
![Reliance Stock with Claude](images/what_is_reliance_tradingat_claude.png)
...
![Tesla Price Move (Claude)](images/why_tesla_stock_moved_claude.png)
...
![Buy Tesla (Claude)](images/should_I_buy_tesla.png)

And it failed with a polite message from the agent _"I am not able to provide investment advise...."_. This behavior is consistent with the prompt (`instruction`) we gave our agent - don't give advise!

## Conclusion

Whew 😥! That concludes a rather long lesson. Hope your'e still with us 😊. 
